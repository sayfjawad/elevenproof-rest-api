...
public class BsnServiceTest {
  ...
  public void validateBsn_true() {
    ...
    bsnService = new BsnService();
    assertThat(bsnService.isValidBsn(new ElevenProofNumber("286158838"))).isTrue();
    assertThat(bsnService.isValidBsn(new ElevenProofNumber("123456789"))).isFalse();
  }
  ...
  public void validateBsn_false() {
    ...
    bsnService = new BsnService();
    assertThat(bsnService.isValidBsn(new ElevenProofNumber("123456789"))).isFalse();
    assertThat(bsnService.isValidBsn(new ElevenProofNumber("12345678"))).isFalse();
    assertThat(bsnService.isValidBsn(new ElevenProofNumber("A12345678"))).isFalse();
    assertThat(bsnService.isValidBsn(new ElevenProofNumber(null))).isFalse();
  }
}